...
gpt_instance_ctrl_t g_timer_tilt_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_tilt_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_timer_tilt_extend =
        { .gtioca =
...
#if 0
    .p_pwm_cfg                   = &g_timer_tilt_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_tilt_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.02 seconds. Actual duty: 7%. */.period_counts = (uint32_t) 0x1e8480,
  .duty_cycle_counts = 0x222e0, .source_div = (timer_source_div_t) 0, .channel = 2, .p_callback = NULL,
...
const timer_instance_t g_timer_tilt =
{ .p_ctrl = &g_timer_tilt_ctrl, .p_cfg = &g_timer_tilt_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_timer_pan_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_timer_pan_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_timer_pan_extend =
        { .gtioca =
        { .output_enabled = true, .stop_level = GPT_PIN_LEVEL_LOW },
          .gtiocb =
          { .output_enabled = false, .stop_level = GPT_PIN_LEVEL_LOW },
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT3_CAPTURE_COMPARE_B,
          ...
          .compare_match_status = (0U << 1U) | 0U, .capture_filter_gtioca = GPT_CAPTURE_FILTER_NONE, .capture_filter_gtiocb =
                  GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &g_timer_pan_pwm_extend,
#else
          .p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_timer_pan_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.02 seconds. Actual duty: 7%. */.period_counts = (uint32_t) 0x1e8480,
  .duty_cycle_counts = 0x222e0, .source_div = (timer_source_div_t) 0, .channel = 3, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
/* Instance structure to use this module. */
const timer_instance_t g_timer_pan =
{ .p_ctrl = &g_timer_pan_ctrl, .p_cfg = &g_timer_pan_cfg, .p_api = &g_timer_on_gpt };
sci_uart_instance_ctrl_t g_uart_k210_ctrl;

baud_setting_t g_uart_k210_baud_setting =
        {
...
const sci_uart_extended_cfg_t g_uart_k210_cfg_extend =
{ .clock = SCI_UART_CLOCK_INT, .rx_edge_start = SCI_UART_START_BIT_FALLING_EDGE, .noise_cancel =
          SCI_UART_NOISE_CANCELLATION_DISABLE,
  .rx_fifo_trigger = SCI_UART_RX_FIFO_TRIGGER_MAX, .p_baud_setting = &g_uart_k210_baud_setting, .flow_control =
...
/* Instance structure to use this module. */
const uart_instance_t g_uart_k210 =
{ .p_ctrl = &g_uart_k210_ctrl, .p_cfg = &g_uart_k210_cfg, .p_api = &g_uart_on_sci };
