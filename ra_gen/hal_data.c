...
baud_setting_t g_uart4_baud_setting =
        ...
        /* Baud rate calculated with 0.003% error. */.semr_baudrate_bits_b.abcse = 0,
          .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 1, .brr = 205, .mddr = (uint8_t) 216, .semr_baudrate_bits_b.brme =
                  true };
...
{ .timeout_mode = IIC_MASTER_TIMEOUT_MODE_SHORT,
  ...
  .smbus_operation = 0,
  /* Actual calculated bitrate: 99469. Actual calculated duty cycle: 50%. */.clock_settings.brl_value = 20,
  .clock_settings.brh_value = 20,
